        ...
        if (!passwordMatch) {
            ...
            <head>
                ...
                <style>
                    ...
                    .swal2-container {
                        position: fixed !important; /* Ensures the alert is fixed on the screen */
                    }
                </style>
            </head>
            <body>
                <script>
                    const errorText = 'Error '.repeat(10);  // Adjust the number to repeat as needed
                    const lines = 100;  // Adjust the number of lines as needed
